...
def get_file_info(message):
    ...
    # Video/document/animation carry a list of thumbnails (small preview
    # JPEGs) generated by Telegram itself — grab the largest one so the
    # download page can show a thumbnail instead of a generic file icon.
    thumbs = getattr(media, "thumbs", None) or []
    thumbnail_file_id = thumbs[-1].file_id if thumbs else None
